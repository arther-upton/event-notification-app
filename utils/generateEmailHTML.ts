export const generateEmailHTML = (templateType: "invitation" | "cancellation", title: string, host: string | undefined, venue: string, venueType: string, link: string, date: Date) => {
                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <h2>${title}</h2>
                        <p>📨&nbsp; You are invited by ${host} to ${title}</p>
                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <h2>${title}</h2>
                        <p>😕&nbsp; This event planned at ${venue} on ${date.toString()} has been cancelled.</p>
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="btn btn-primary">
                          <tbody>
                            <tr>
                              <td align="center">
